...
contract ExampleYielder is IYielder {
	...
	function withdraw(uint256 _amount, address payable _beneficiary) external override {}

	function withdrawAll(address payable _beneficiary) external override returns (uint256) {}
}
