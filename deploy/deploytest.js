...
async function main() {
	...
	const ProxyPaymentAddressManager = await deployContractFn('ProxyPaymentAddressManager', [
		'0x5bc03B208d46b7b9614252Fd75E68BDB45312105',
		'0xe4cDF4259B3028A9E0ce864FddDFCc1F779f1D9a',
	]);
	console.log('ProxyPaymentAddressManager: ', ProxyPaymentAddressManager.address);

	const Active7DaysFundingCycleBallot = await deployContractFn('Active7DaysFundingCycleBallot', []);
	console.log('Active7DaysFundingCycleBallot: ', Active7DaysFundingCycleBallot.address);

	// await executeFn({
	// 	caller: deployer,
	// 	contractName: 'TerminalV1',
	// 	contractAddress: '0xfc8eFA18687689206372B93De68f486604DedEa6',
	// 	fn: 'deploy',
	// 	args: [
	// 		deployer.address,
