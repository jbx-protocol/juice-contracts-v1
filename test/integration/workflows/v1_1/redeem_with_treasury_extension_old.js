...
export default [
  {
    ...
    fn: async ({
      ...
      console.log({ a: treasuryExtension.address });
      await executeFn({
        caller: deployer,
      ...
      console.log({ reservedRate, bondingCurveRate, reconfigurationBondingCurveRate });
  ...
  },
  {
    ...
    fn: async ({
      ...
      const expectedClaimableAmount = bondingCurveFn({
      ...
      const insufficientLiquidityForTicketBenificiary1 = expectedClaimableAmount.gt(overflow);

      console.log({ overflow, expectedClaimableAmount, redeemableTicketsOfTicketBeneficiary1 })
      await checkFn({
        caller: randomSignerFn(),
        contract: contracts.terminalV1_1,
        ...
        expect: insufficientLiquidityForTicketBenificiary1 ? overflow : expectedClaimableAmount,
  ...
  },
  {
    ...
    fn: async ({
      ...
      const expectedClaimableAmount = bondingCurveFn({
        ...
        overflow: overflow
          .add(await treasuryExtension.ETHValue(expectedProjectId))

      });

      const insufficientLiquidityForTicketBenificiary2 = expectedClaimableAmount.gt(overflow);
      ...
      await checkFn({
        ...
        expect: insufficientLiquidityForTicketBenificiary2 ? overflow : expectedClaimableAmount,
        // Allow some wiggle room due to possible division precision errors.
        plusMinus: {
          amount: 100,
        },
  ...
  //     randomAddressFn,
  //     BigNumber,
  //     local: { redeemableTicketsOfTicketBeneficiary2, expectedProjectId, ticketBeneficiary2, noLiquidityForTicketBenificiary2 },
  //   }) => {
  //     // An address that will be the beneficiary of funds when redeeming the first set of tickets.
  ...
  //     // Get the stored claimable amount.
  //     const redeemableAmountOfTicketBeneficiary2 = noLiquidityForTicketBenificiary2 ? BigNumber.from(0) : await contracts.terminalV1_1.claimableOverflowOf(
  //       ticketBeneficiary2.address,
  //       expectedProjectId,
  //       redeemableTicketsOfTicketBeneficiary2,
  //     );
  ...
  //       leftoverTicketsOfTicketBeneficiary2: redeemableTicketsOfTicketBeneficiary2.eq(0) || noLiquidityForTicketBenificiary2 ? redeemableAmountOfTicketBeneficiary2 : BigNumber.from(0)
  //     };
  //   },
  // },
  // {
  ...
  //     const noLiquidityForTicketBenificiary3 = expectedClaimableAmount.gt(overflow);
  ...
  //     return {
  //       redeemableTicketsOfTicketBeneficiary3,
  //       noLiquidityForTicketBenificiary3
  //     };
  //   },
  // },
  // {
  //   description: 'The third ticket beneficiary can only redeem successfully if theres enough in the treasury',
  //   fn: async ({
  //     randomBoolFn,
  //     contracts,
  //     executeFn,
  ...
  //     randomAddressFn,
  //     BigNumber,
  //     local: { redeemableTicketsOfTicketBeneficiary3, expectedProjectId, ticketBeneficiary3, noLiquidityForTicketBenificiary3 },
  //   }) => {
  //     // An address that will be the beneficiary of funds when redeeming the first set of tickets.
  ...
  //       leftoverTicketsOfTicketBeneficiary3: noLiquidityForTicketBenificiary3 ? redeemableTicketsOfTicketBeneficiary3 : BigNumber.from(0),
  //     };
  //   },
  // },
  // {
  ...
  //     randomSignerFn,
  //     bondingCurveFn,
  //     local: { expectedProjectId, owner, bondingCurveRate, treasuryExtension },
  //   }) => {
  ...
  //     const overflow = (await contracts.terminalV1_1.currentOverflowOf(expectedProjectId));

  //     const expectedClaimableAmount = overflow.add(await treasuryExtension.ETHValue(expectedProjectId));

  //     const noLiquidityForOwner = expectedClaimableAmount.gt(overflow);
  ...
  //     return { reservedTicketBalance, noLiquidityForOwner };
  //   },
  // },
  // {
  ...
  //     randomAddressFn,
  //     BigNumber,
  //     local: { expectedProjectId, owner, reservedTicketBalance, noLiquidityForOwner },
  //   }) => {
  ...
  //     const claimableOverflow = noLiquidityForOwner ? BigNumber.from(0) : await contracts.terminalV1_1.claimableOverflowOf(
  //       owner.address,
  //       expectedProjectId,
  ...
  //     const leftoverReservedTickets = expectNoOp || noLiquidityForOwner ? reservedTicketBalance : BigNumber.from(0);
