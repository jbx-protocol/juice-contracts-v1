/** 
  The governance of the terminalV1dot1 can transfer its power to a new address.
...
export default [
  {
    ...
    fn: ({ executeFn, deployer, contracts, randomBigNumberFn, constants }) =>
      executeFn({
        ...
        fn: 'setFee',
        args: [contracts.terminalV1dot1.address, randomBigNumberFn({ max: constants.MaxPercent })],
      }),
  },
  {
    ...
    fn: async ({ executeFn, deployer, contracts, randomSignerFn }) => {
      ...
      await executeFn({
        ...
        args: [contracts.terminalV1dot1.address, firstAppointedGovernance.address],
      });
  ...
  },
  {
    ...
    fn: ({
      ...
      executeFn({
        ...
        revert: 'TerminalV1dot1: UNAUTHORIZED',
      }),
  },
  {
  ...
  },
  {
    ...
    fn: async ({ executeFn, deployer, contracts, randomSignerFn }) => {
      ...
      await executeFn({
        ...
        contract: contracts.governance,
        fn: 'appointGovernance',
        args: [contracts.terminalV1dot1.address, secondAppointedGovernance.address],
      });
  ...
  },
  {
    ...
    fn: ({ executeFn, contracts, deployer }) => {
      executeFn({
        ...
        contract: contracts.governance,
        fn: 'acceptGovernance',
        args: [contracts.terminalV1dot1.address],
      });
    },
  },
];
