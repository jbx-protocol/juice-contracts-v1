/** 
  Deploying a project through the terminalV1dot1 should create a project, configure a funding cycle, and set mods.
...
export default [
  {
    ...
    fn: async ({
      ...
      const contract = contracts.terminalV1dot1;
  ...
  {
    description: "Make sure the terminalV1dot1dot1 got set as the project's current terminal",
