...
export default [
    ...
    fn: async ({
      ...
      const expectedFeeAmount1 = amountToTap1.sub(
        amountToTap1
          ...
          .div((await contracts.terminalV1dot1.fee()).add(constants.MaxPercent)),
      );
  ...
  {
    description: 'Allow migration to a new terminalV1dot1',
    fn: async ({ deployer, contracts, executeFn, deployContractFn }) => {
      ...
      await executeFn({
        ...
        fn: 'allowMigration',
        args: [contracts.terminalV1dot1.address, secondTerminalV1.address],
      });
  ...
  {
    description: 'Migrating to the new terminalV1dot1',
  ...
  {
    description: 'Tap funds for the project in the second terminalV1dot1 to incure the fee',
    fn: async ({
      executeFn,
      randomSignerFn,
