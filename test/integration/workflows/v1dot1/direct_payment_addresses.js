...
export default [
  ...
  {
    description: "Make sure the terminalV1dot1 got set as the project's current terminal",
  ...
  },
  {
    ...
    fn: ({ contracts, executeFn, local: { owner, expectedProjectId, secondTerminalV1dot1 } }) =>
      executeFn({
        caller: owner,
        contract: contracts.terminalV1dot1,
        fn: 'migrate',
  ...
  },
  {
    ...
    fn: ({
      checkFn,
      randomSignerFn,
      local: { paymentValue, expectedProjectId, secondTerminalV1dot1 },
    }) =>
      checkFn({
        caller: randomSignerFn(),
