...
export default [
  {
    ...
    fn: async ({
      ...
      return {
        ...
        paymentValue2,
        paymentValue3,
        initialContractBalance: await getBalanceFn(contracts.terminalV1dot1.address),
        ballot,
  ...
  {
    description: 'The terminalV1dot1 should have the funds from the payments',
    fn: ({
      contracts,
      verifyBalanceFn,
  ...
  },
  {
    ...
    fn: async ({
      ...
      const redeemableAmountOfTicketBeneficiary1 = await contracts.terminalV1dot1.claimableOverflowOf(
        ticketBeneficiary1.address,
        expectedProjectId,
        redeemableTicketsOfTicketBeneficiary1,
      );
  ...
  {
    description:
      'The terminalV1dot1 should no longer have the funds sent to the first redeem beneificiary',
    fn: ({
      contracts,
      verifyBalanceFn,
      local: {
  ...
  },
  {
    ...
    fn: async ({
      ...
      // Get the stored claimable amount.
      const redeemableAmountOfTicketBeneficiary2 = await contracts.terminalV1dot1.claimableOverflowOf(
        ticketBeneficiary2.address,
        expectedProjectId,
        redeemableTicketsOfTicketBeneficiary2,
      );
  ...
  {
    description:
      'The terminalV1dot1 should no longer have the funds sent to the second redeem beneificiary',
    fn: ({
      contracts,
      verifyBalanceFn,
      local: {
  ...
  },
  {
    ...
    fn: async ({
      ...
      // Get the stored claimable amount.
      const redeemableAmountOfTicketBeneficiary3 = await contracts.terminalV1dot1.claimableOverflowOf(
        ticketBeneficiary3.address,
        expectedProjectId,
        redeemableTicketsOfTicketBeneficiary3,
      );
    ...
    fn: async ({
      ...
      await checkFn({
        ...
        expect: bondingCurveFn({
          ...
          overflow: await contracts.terminalV1dot1.currentOverflowOf(expectedProjectId),
        }),
        // Allow some wiggle room due to possible division precision errors.
        plusMinus: {
          amount: 100,
  ...
  },
  {
    ...
    fn: async ({
      ...
      const claimableOverflow = await contracts.terminalV1dot1.claimableOverflowOf(
        owner.address,
        expectedProjectId,
