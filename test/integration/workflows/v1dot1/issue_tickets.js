...
export default [
  ...
  },
  {
    ...
    fn: async ({
      ...
      const claimableAmount = await contracts.terminalV1dot1.claimableOverflowOf(
        ticketBeneficiary.address,
        expectedProjectId,
        redeemedPortionOfStakedBalance,
      );

      const expectNoOp = redeemedPortionOfStakedBalance.eq(0);
