...
export default [
  ...
  {
    description: "Migrating to a terminalV1_1 shouldn't work because it hasn't been allowed yet",
    fn: async ({ contracts, executeFn, deployContractFn, local: { owner, expectedProjectId } }) => {
      // The terminalV1_1 that will be migrated to.
      const terminalV1_1 = await deployContractFn('TerminalV1_1', [
      ...
      await executeFn({
        ...
        contract: contracts.terminalV1,
        fn: 'migrate',
        args: [expectedProjectId, terminalV1_1.address],
  ...
  },
  {
    ...
    fn: ({ deployer, contracts, executeFn, local: { terminalV1_1 } }) =>
      executeFn({
        caller: deployer,
        contract: contracts.governance,
        fn: 'allowMigration',
        args: [contracts.terminalV1.address, terminalV1_1.address],
      }),
  },
  {
    description:
    ...
    fn: ({
      ...
      executeFn,
      randomSignerFn,
      local: { owner, expectedProjectId, terminalV1_1, redeemBeneficiary },
    }) =>
      executeFn({
  ...
  },
  {
    ...
    fn: async ({
      contracts,
      executeFn,
      local: { owner, expectedProjectId, terminalV1_1, reservedRate },
    }) => {
  ...
  },
  {
    ...
    fn: async ({
      ...
      await verifyBalanceFn({
        address: contracts.terminalV1.address,
        expect: initialTerminalV1Balance.add(amountToTap1)
  ...
  },
  {
    ...
    fn: ({ contracts, checkFn, randomSignerFn, local: { expectedProjectId, terminalV1_1 } }) =>
      checkFn({
        caller: randomSignerFn(),
        contract: contracts.terminalDirectory,
        fn: 'terminalOf',
        args: [expectedProjectId],
        expect: terminalV1_1.address,
      }),
  },
  {
    description: 'The reserved tokens should be empty in the new terminalV1_1',
    fn: ({ checkFn, BigNumber, randomSignerFn, constants, randomBigNumberFn, local: { expectedProjectId, terminalV1_1 } }) =>
      checkFn({
        caller: randomSignerFn(),
        contract: terminalV1_1,
  ...
  {
    description: 'Payments to the old TerminalV1 should no longer be accepted for the project',
    fn: ({
      contracts,
      executeFn,
      randomAddressFn,
  ...
  },
  {
    ...
    fn: ({
      executeFn,
      randomSignerFn,
      local: { target, expectedProjectId, amountToTap1, terminalV1_1 },
    }) =>
      executeFn({
        caller: randomSignerFn(),
        contract: terminalV1_1,
  ...
  },
  {
    ...
    fn: ({
      ...
      randomAddressFn,
      randomBoolFn,
      local: { reservedTicketAmount, owner, reservedRate, expectedProjectId, terminalV1_1 },
    }) =>
      executeFn({
        caller: owner,
        contract: terminalV1_1,
  ...
  },
  {
    ...
    fn: ({
      ...
      randomBoolFn,
      randomStringFn,
      local: { payer, paymentValue2, expectedProjectId, terminalV1_1 },
    }) =>
      executeFn({
        caller: payer,
        contract: terminalV1_1,
