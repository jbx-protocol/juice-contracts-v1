...
export default [
	...
	},
	{
		...
		fn: ({ executeFn, contracts, randomStringFn, randomSignerFn, local: { owner, expectedProjectId } }) =>
			executeFn({
	...
	},
	{
		...
		fn: ({ executeFn, contracts, randomStringFn, local: { owner, secondOwner, expectedProjectId } }) =>
			executeFn({
				caller: owner,
				contract: contracts.projects,
				fn: 'setUri',
