...
export default [
	...
	{
		description: "Overriding a locked mod with a shorter locked date shouldn't work when setting payout mods",
		fn: ({
			contracts,
			executeFn,
			timeMark,
	...
	},
	{
		...
		fn: ({ contracts, executeFn, timeMark, local: { owner, expectedProjectId, unlockedMod2, lockedMod1 } }) =>
			executeFn({
				caller: owner,
				contract: contracts.modStore,
				fn: 'setPayoutMods',
