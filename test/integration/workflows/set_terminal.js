...
export default [
	...
	},
	{
		...
		fn: ({ constants, contracts, executeFn, randomBigNumberFn, BigNumber, local: { expectedProjectId, owner } }) =>
			executeFn({
				caller: owner,
				contract: contracts.terminalV1,
				fn: 'configure',
	...
	{
		description: 'Setting a new terminal before migration to it has been allowed shouldnt be allowed',
	...
	{
		description: 'Set a terminal that can be migrated to from the current terminal should be allowed',
