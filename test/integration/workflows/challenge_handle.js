...
export default [
	...
	},
	{
		...
		fn: async ({ deployer, contracts, executeFn, randomStringFn, randomSignerFn, local: { handle } }) => {
	...
	{
		description: 'The claimer can renew the handle so that it cannot be claimed without being challenged again.',
