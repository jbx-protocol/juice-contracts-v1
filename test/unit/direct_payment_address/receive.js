	...
	describe('Success cases', function () {
		tests.success.forEach(function (successTest) {
			it(successTest.description, async function () {
				...
				await this.terminalDirectory.mock.terminalOf.withArgs(this.projectId).returns(this.terminalV1.address);
				...
				await expect(tx)
					...
					.withArgs(caller.address, this.projectId, beneficiary, value, this.memo, preferUnstakedTickets);
			});
		});
	});
}
