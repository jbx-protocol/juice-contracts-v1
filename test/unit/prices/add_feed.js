	...
	describe('Success cases', function () {
		tests.success.forEach(function (successTest) {
			it(successTest.description, async function () {
				...
				const tx = await this.contract.connect(caller).addFeed(this.aggregatorV3Contract.address, currency);
				...
				const expectedFeedDecimalAdjuster = ethers.BigNumber.from(10).pow(targetDecimals - decimals);
