...
const tests = {
  success: [
    ...
    },
    {
      ...
      fn: () => ({
        amount: BigNumber.from(10).pow(18).mul(9),
        reservedRate: 20,
      }),
    },
    {
      ...
      fn: () => ({
        target: BigNumber.from(10).pow(18).mul(200),
        tapped: BigNumber.from(10).pow(18).mul(100),
        ethPrice: BigNumber.from(10).pow(18).mul(2),
        addToBalance: BigNumber.from(10).pow(18).mul(100),
        amount: BigNumber.from(10).pow(18).mul(50),
      }),
    },
    {
      description: 'with no balance to claim',
      fn: () => ({
        target: BigNumber.from(10).pow(18).mul(200),
        tapped: BigNumber.from(10).pow(18).mul(100),
    ...
    {
      description: 'With some tappable and bonding curve of 50%, redeeming 50% of the supply',
      fn: () => ({
        target: BigNumber.from(10).pow(18).mul(200),
        tapped: BigNumber.from(10).pow(18).mul(100),
        ethPrice: BigNumber.from(10).pow(18).mul(2),
        ...
        count: BigNumber.from(10).pow(18).mul(5),
        ticketBalance: BigNumber.from(10).pow(18).mul(5),
        ticketTotalSupply: BigNumber.from(10).pow(18).mul(10),
        // rate should be %37.5
        amount: BigNumber.from(10).pow(18).mul(50).mul(375).div(1000),
      }),
    },
    {
      description: 'With some tappable and bonding curve of 50%, redeeming 10% of supply',
      fn: () => ({
        target: BigNumber.from(10).pow(18).mul(200),
        tapped: BigNumber.from(10).pow(18).mul(100),
        ethPrice: BigNumber.from(10).pow(18).mul(2),
        ...
        bondingCurveRate: 100,
        // Half the amount of tickets.
        count: BigNumber.from(10).pow(18).mul(1),
        ticketBalance: BigNumber.from(10).pow(18).mul(1),
        ticketTotalSupply: BigNumber.from(10).pow(18).mul(10),
        // rate should be %5.5
        amount: BigNumber.from(10).pow(18).mul(50).mul(55).div(1000),
      }),
    },
    {
      description: 'With some tappable and bonding curve of 10%, redeeming 50% of supply',
      fn: () => ({
        target: BigNumber.from(10).pow(18).mul(200),
        tapped: BigNumber.from(10).pow(18).mul(100),
        ethPrice: BigNumber.from(10).pow(18).mul(2),
        ...
        ticketTotalSupply: BigNumber.from(10).pow(18).mul(10),
        // rate should be %27.5
        amount: BigNumber.from(10).pow(18).mul(50).mul(275).div(1000),
      }),
    },
    {
      description: 'With some tappable and bonding curve of 10%, redeeming 10% of supply',
      fn: () => ({
        target: BigNumber.from(10).pow(18).mul(200),
        tapped: BigNumber.from(10).pow(18).mul(100),
        ethPrice: BigNumber.from(10).pow(18).mul(2),
        ...
        ticketTotalSupply: BigNumber.from(10).pow(18).mul(10),
        // rate should be %1.9
        amount: BigNumber.from(10).pow(18).mul(50).mul(19).div(1000),
      }),
    },
    {
      description: 'With some tappable and reconfiguration bonding curve of 50%',
      fn: () => ({
        target: BigNumber.from(10).pow(18).mul(200),
        tapped: BigNumber.from(10).pow(18).mul(100),
        ethPrice: BigNumber.from(10).pow(18).mul(2),
    ...
    },
    {
      ...
      fn: () => ({
        ...
        ethPrice: BigNumber.from(10).pow(18).mul(2),
        addToBalance: BigNumber.from(10).pow(18).mul(100),
        minReturnedWei: BigNumber.from(10).pow(18).mul(50),
        amount: BigNumber.from(10).pow(18).mul(50),
      }),
    },
    {
      ...
      fn: () => ({
        count: BigNumber.from(2).pow(255).sub(1),
        ticketBalance: BigNumber.from(2).pow(255).sub(1),
        ticketTotalSupply: BigNumber.from(2).pow(255).sub(1),
      }),
    },
  ],
  failure: [
...
const ops =
  ({ deployer, addrs, mockContracts, targetContract }) =>
    async (custom) => {
      const {
        caller = deployer,
        ...
        projectOperator = false,
        wildcardOperator = false,
        addToBalance = BigNumber.from(10).pow(18).mul(10),
        beneficiary = addrs[0].address,
        count = BigNumber.from(10).pow(18).mul(10),
        ticketBalance = BigNumber.from(10).pow(18).mul(10),
        ticketTotalSupply = BigNumber.from(10).pow(18).mul(10),
        ethPrice = BigNumber.from(10).pow(18).mul(42),
        ...
        target = BigNumber.from(10).pow(18).mul(100),
        tapped = BigNumber.from(10).pow(18).mul(100),
        currency = 42,
        revert,
      } = {
      ...
      const initialBeneficiaryBalance = await deployer.provider.getBalance(beneficiary);
      return [
        mockFn({
        ...
        executeFn({
          ...
          contract: targetContract,
          fn: 'redeem',
          args: [account, projectId, count, minReturnedWei, beneficiary, preferUnstaked],
          events: [
            {
              name: 'Redeem',
