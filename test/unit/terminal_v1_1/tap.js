...
const tests = {
  success: [
    ...
    },
    {
      ...
      fn: () => ({
        fee: 20,
        tapped: BigNumber.from(10).pow(18).mul(20),
        leftover: BigNumber.from(10).pow(18).mul(20),
        feeAmount: BigNumber.from(10).pow(18).mul(2),
    ...
    },
    {
      ...
      fn: async ({ addrs, mockContracts, multisig, contractName, deployMockLocalContractFn }) => {
        ...
        return {
          ...
          leftover: BigNumber.from(10).pow(18).mul(11),
        };
      },
    },
    {
      ...
      fn: async ({ addrs, deployMockLocalContractFn }) => {
        ...
        return {
          ...
          leftover: BigNumber.from(10).pow(18).mul(22).div(4),
        };
      },
    },
    {
  ...
  failure: [
    {
      ...
      fn: () => ({
        currency: 19,
        revert: 'TV1_1::tap: UNEXPECTED_CURRENCY',
      }),
    },
    {
      ...
      fn: () => ({
        ...
        revert: 'TV1_1::tap: INSUFFICIENT_FUNDS',
      }),
    },
    {
  ...
  ({ deployer, multisig, addrs, mockContracts, deployMockLocalContractFn, deployContractFn, contractName }) =>
    async (custom) => {
      const {
        ...
        addToBalance = BigNumber.from(10).pow(18).mul(44),
        amount = BigNumber.from(10).pow(18).mul(44),
        ethPrice = BigNumber.from(10).pow(18).mul(2),
        tapped = BigNumber.from(10).pow(18).mul(22),
        leftover = BigNumber.from(10).pow(18).mul(22),
        projectMod,
        addressMod,
        allocatorMod,
        ...
        ...(projectMod
          ? [
            mockFn({
              ...
              returns: [
                (projectMod.terminal && projectMod.terminal.address) || targetContract.address,
              ],
            }),
        ...
        ...(!revert && addressMod
          ? [
            check({
              ...
              value: (await caller.provider.getBalance(addressMod.beneficiary)).add(
                tapped.mul(addressMod.percent).div(10000),
              ),
            }),
          ]
        ...
        ...(!revert && allocatorMod
          ? [
            check({
              ...
              value: (await caller.provider.getBalance(allocatorMod.allocator)).add(
                tapped.mul(allocatorMod.percent).div(10000),
              ),
            }),
          ]
