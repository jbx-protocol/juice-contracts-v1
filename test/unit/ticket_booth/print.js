	...
	describe('Success cases', function () {
		tests.success.forEach(function (successTest) {
			it(successTest.description, async function () {
				const { caller, projectId, holder, amount, preferUnstaked, withERC20 } = successTest.fn(this);
				...
				await expect(tx)
					...
					.withArgs(holder, projectId, amount, withERC20 && preferUnstaked, preferUnstaked, caller.address);
