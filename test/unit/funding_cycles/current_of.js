	...
	success: [
		...
		},
		{
			...
			fn: testTemplate({
				...
				// Fast forward past the full duration.
				fastforward: BigNumber.from(96401),
				expectation: {
					number: 2,
					id: 0,
				},
	...
	describe('Success cases', function () {
		tests.success.forEach(function (successTest) {
			it(successTest.description, async function () {
				const { caller, projectId, setup: { preconfigure, ops = [] } = {}, expectation } = successTest.fn(this);
				...
				const storedCurrentFundingCycle = await this.contract.currentOf(projectId);
